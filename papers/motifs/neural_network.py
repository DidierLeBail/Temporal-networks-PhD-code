...
from libs.settings import Setup_Plot,Cosim,Get_versions,Load_instance_param,Get_savename,Raw_to_binned,Load_TN_ADM,Savename_to_name
from libs.atn import ADM_class,Min_EW
...
def Get_sizes_TN():
	list_savename = Get_tot_TN_not_randomized()
	res = []
...
def Flows_to_sentences(archive_name,list_obs=None,list_name=None):
	...
	if list_name is None:
		list_name = Get_tot_TN_not_randomized()
	cla = Symb_conv()
